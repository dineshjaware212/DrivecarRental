...
Version 2.6.0 adds a **WhatsApp Sharing** page under Rental Operations. It shares the complete rental terms, the configured Google Maps pickup/drop location, and the payment QR with a prepared INR 500 booking-token message.
